...
async function epubcheck(filename: string): Promise<boolean> {
    const cmd = new Deno.Command("/usr/bin/java", {
        args   : ["-jar", "epubcheck.jar", filename],
        stdout : "piped",
        stderr : "piped",
    });
...
async function testOne(runData: RunData): Promise<boolean> {
    ...
    const check: boolean = await epubcheck(runData.output);
...
const tests: Suite = {
    "epub-overview-33" : {
        url    : "http://localhost:8001/LocalData/github/Tools/r2epub/explore/spec/Overview.html",
        respec : false,
    ...
    "aria" : {
        url    : "http://localhost:8001/LocalData/github/Tools/r2epub/explore/aria/Overview.html",
        respec : false,
        output : "aria.epub",
        remove : false,
        trace  : false,
    ...
    "clreq" : {
        url    : "http://localhost:8001/LocalData/github/Tools/r2epub/explore/clreq/Overview.html",
        respec : false,
        output : "clreq.epub",
        remove : false,
        trace  : false,
    ...
    "epub-overview-34" : {
        url    : "http://localhost:8001/LocalData/github/Tools/r2epub/explore/darkmode/Overview.html",
        respec : false,
...
// We know that, currently, epubcheck rejects this, and the error message is huge...
Deno.test.ignore(
