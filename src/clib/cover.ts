...
/**
 * Create the HTML content for a cover page.
 *
 ...
 * @returns a text representation of the cover xhtml file.
 */
export function create_cover_page(book :cConvert.Collection) :string {
    const date_to_string = (date :string) :string => {
    ...
    return cover
        ...
        .replace('%%%DATE%%%', date_to_string(book.date));
}
