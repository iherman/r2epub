...
* The logo and css files, adapted for EPUB usage (e.g., `base.css`, W3C logos, etc) are served [from github](https://iherman.github.io/respec-to-epub/epub_assets/) instead of my page on W3C.
