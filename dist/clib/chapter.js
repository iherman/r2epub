...
/**
 * These are common items for all books generated by r2epub, and used by the cover page. This must be transferred to the final book, but only once.
 */
const transfer_once = [
...
/**
 * These resources are present in the chapter's OCF, but should be regenerated from scratch for the final book, ie, should never be transferred.
 */
...
class Chapter {
    ...
    async initialize() {
        ...
        const not_to_transfer = this._first_chapter ? never_transfer : [...transfer_once, ...never_transfer];
