...
/**
 * Creation of the of the Package file for a collection, per the [EPUB 3 Package Document Specification](https://www.w3.org/TR/epub/#sec-package-doc). See also [the `PackageWrapper` documentation](https://iherman.github.io/r2epub/typedoc/classes/_lib_opf_.packagewrapper.html).
 *
 * The method
 *
